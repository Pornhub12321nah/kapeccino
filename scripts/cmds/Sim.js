...
module.exports = {
  config: {
    ...
    role: 0,
    description: {
      en: 'Talk with yuta Ai ♡'
    },
    category: 'fun',
    guide: {
      en: ' {pn} [on | off]: on/off yuta Ai ♡' 
        + '\n{pn} <word>: chat with yuta Ai ♡' 
        + '\nExample:\n{pn} hi'
    }
  },
  langs: {
    en: {
      turnedOn: 'Turned on yuta-AI ♡ successfully!',
      turnedOff: 'Turned off yuta-AI ♡ successfully!',
      chatting: 'Already Chatting with yuta-AI ♡...',
      error: 'Huh?🙂'
    }
  },
